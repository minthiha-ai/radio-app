                    ...
                    E = (function () {
                        function e(t, i) {
                            ...
                            if (
                                ...
                                var h = this.passedElement.value.split(
                        ...
                        return (
                            ...
                            (e.prototype.highlightItem = function (e, t) {
                                ...
                                var i = e.id,
                                    ...
                                    h =
                                        o >= 0
                                            ? this._store.getGroupById(o)
                                            : null;
                                return (
                                    this._store.dispatch(
                                        (0, l.highlightItem)(i, !0)
                                    ),
                                    t &&
                            ...
                            (e.prototype.removeActiveItemsByValue = function (
                                e
                            ) {
                                var t = this;
                                return (
                            ...
                            (e.prototype.clearChoices = function () {
                                return (
                                    this._store.dispatch((0, a.clearChoices)()),
                                    this
                                );
                            }),
                            (e.prototype.clearStore = function () {
                                return (
                                    this._store.dispatch((0, h.clearAll)()),
                                    this
                                );
                            }),
                            ...
                            (e.prototype._renderChoices = function () {
                                ...
                                if (
                                    ...
                                    r.length >= 1 &&
                                        (o = this._createChoicesFragment(r, o)),
                                        (o = this._createGroupsFragment(
                                            i,
                                            n,
                                            o
                                        ));
                                    ...
                                    n.length >= 1 &&
                                        (o = this._createChoicesFragment(n, o));
                            ...
                            (e.prototype._createGroupsFragment = function (
                                ...
                                return (
                                    ...
                                    e.forEach(function (e) {
                                        ...
                                        if (o.length >= 1) {
                                            var r = n._getTemplate(
                                                "choiceGroup",
                                                e
                                            );
                                            i.appendChild(r),
                                                n._createChoicesFragment(
                                                    o,
                                                    i,
                                                    !0
                                                );
                            ...
                            (e.prototype._createChoicesFragment = function (
                                ...
                                var r = this.config,
                                    ...
                                    h = function (e) {
                                        if (
                                            "auto" !== s ||
                                            o._isSelectOneElement ||
                                            !e.selected
                                        ) {
                                            var i = o._getTemplate(
                                                "choice",
                                                e,
                                                o.config.itemSelectText
                                            );
                                            t.appendChild(i);
                                        }
                                    },
                            ...
                            (e.prototype._createItemsFragment = function (
                                e,
                                t
                            ) {
                                var i = this;
                            ...
                            (e.prototype._selectPlaceholderChoice = function (
                                e
                            ) {
                                this._addItem({
                                    value: e.value,
                            ...
                            (e.prototype._handleItemAction = function (
                                e,
                                t,
                                i
                            ) {
                            ...
                            (e.prototype._onBlur = function (e) {
                                ...
                                if (
                                    ...
                                    var o = this._store.activeItems.some(
                                        function (e) {
                                            return e.highlighted;
                                        }
                                    );
                            ...
                            (e.prototype._onFormReset = function () {
                                this._store.dispatch(
                                    (0, h.resetTo)(this._initialState)
                                );
                            }),
                            ...
                            (e.prototype._findAndSelectChoiceByValue =
                                function (e) {
                                    var t = this,
                                        i = this._store.choices.find(function (
                                            i
                                        ) {
                            ...
                            (e.prototype._generatePlaceholderValue =
                                function () {
                                    if (
                                        this._isSelectElement &&
                ...
                var n = i(883),
                    o = (function () {
                        ...
                        return (
                            ...
                            (e.prototype.scrollToChildElement = function (
                                e,
                                t
                            ) {
                                var i = this;
                            ...
                            (e.prototype._animateScroll = function (e, t) {
                                var i = this,
                                    ...
                                    s = !1;
                                t > 0
                                    ? (this._scrollDown(r, o, e),
                                      r < e && (s = !0))
                                    : (this._scrollUp(r, o, e),
                                      r > e && (s = !0)),
                                    s &&
                                        requestAnimationFrame(function () {
                    ...
                    o = (function () {
                        ...
                        return (
                            Object.defineProperty(e.prototype, "isActive", {
                                get: function () {
                                    return (
                                        "active" === this.element.dataset.choice
                                    );
                                },
                                enumerable: !1,
                                configurable: !0,
                ...
                var s = (function (e) {
                    function t(t) {
                        var i = t.element,
                            ...
                            o = t.delimiter,
                            r =
                                e.call(this, { element: i, classNames: n }) ||
                                this;
                        ...
                        switch (
                            ...
                            case "FILTER_CHOICES":
                                ...
                                return e.map(function (e) {
                                    var t = e;
                                    return (
                                        (t.active = c.results.some(function (
                                            e
                                        ) {
                                            var i = e.item,
                                                n = e.score;
            ...
            655: function (e, t, i) {
                ...
                t.default = function (e, i) {
                    ...
                    if ("CLEAR_ALL" === i.type) n = t.defaultState;
                        ...
                        return (0, l.cloneObject)(i.state);
                    return h(n, i);
                };
            },
            52: function (e, t) {
                    ...
                    a = (function () {
                        ...
                        return (
                            ...
                            Object.defineProperty(
                                ...
                                {
                                    get: function () {
                                        return this.choices.filter(function (
                                            e
                                        ) {
                                            return !0 === e.active;
                                        });
            ...
            686: function (e, t) {
                ...
                var i = {
                    ...
                    option: function (e) {
                        ...
                        return (
                            n && (s.dataset.customProperties = "".concat(n)),
                            (s.disabled = !!r),
                            s
                        );
                    },
                    ...
                    return function (e, t) {
                        ...
                        for (var n = !1, o = {}, c = 0; c < a.length; c++) {
                            var l = a[c],
                                ...
                                d = h(u, t);
                            if (void 0 === d)
                                throw (t && t.type, new Error(s(14)));
                            (o[l] = d), (n = n || d !== u);
                        }
                        return (n = n || a.length !== Object.keys(e).length)
                            ? o
                            : e;
                    };
                }
